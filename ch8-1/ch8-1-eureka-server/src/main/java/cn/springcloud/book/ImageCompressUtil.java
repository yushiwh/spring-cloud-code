...
//        SpringApplication.run(ImageCompressUtil.class, args);
//    }
    ...
    public static void main(String args[]) throws Exception {
       // ImageCompressUtil.zipImageFile("c:/2.jpg", 1280, 1280, 1f, "x2");
        ImageCompressUtil.saveMinPhoto("c:/2.jpg", "c:/aaa.jpg", 1000, 1);
    }
